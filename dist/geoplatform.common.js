        ...
        _createClass(SectionController, [{
            ...
            value: function fetchOptions(query) {
                ...
                return this.service.query(params).$promise.then(function (response) {
                    _this8.paging.total = response.totalResults;
                    _this8.notify('gp:browse:suggestions:pagination', _this8.paging);
                    _this8.suggested = response.results.map(function (result) {
                        result._selected = _this8.isSelected(result);
                        return result;
                    });
                    _this8.displayOptions.showSuggested = true;
                    return _this8.suggested;
                }).catch(function (e) {
                    _this8.paging.total = 0;
                    _this8.notify('gp:browse:suggestions:pagination', _this8.paging);
                    _this8.suggested = [];
                    return _this8.suggested;
                }).finally(function () {
                    return _this8.displayOptions.fetching = false;
                });
            }
        }, {
            key: "clearQuery",
